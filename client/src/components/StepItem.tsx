...
export default function StepItem({ count, title, description }: StepItemProps) {
  return (
    <div className="flex flex-col items-center max-w-xs px-8">
      <div className="flex justify-center items-center w-8 h-8 bg-white dark:bg-darkmode-dark text-thenex-blue dark:text-darkmode-lighter font-bold border border-solid border-thenex-gray dark:border-darkmode rounded-full">
        {count}
      </div>
