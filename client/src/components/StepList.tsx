...
export default function StepList() {
  const stepDescriptions = [
    ...
    "Jetzt steht Ihre neue Importdatei für das Topix-System zum Download bereit. Nachdem der Download abgeschlossen wurde, werden die vorher hochgeladenen PDF-Dokumente vom Server entfernt.",
  ];
