...
export default function FileItem({ type, file, excelFile }: FileItemProps) {
  ...
  return (
    <div
      ...
      } grid-rows-2 md:grid-rows-1 gap-y-3 md:gap-0 items-center p-3 md:px-5 bg-white dark:bg-darkmode-dark border-b dark:border-darkmode last:shadow-sm last:border-0`}
    >
      <div className="flex justify-start items-center col-span-2 md:col-span-1 md:col-start-1">
        ...
        />
        <span className="inline-block ml-3 text-thenex-gray-dark dark:text-darkmode-lighter text-sm">
          {file.croppedName}
        </span>
      </div>
      {type !== "excel" ? (
        <div className="flex items-center text-thenex-gray-dark col-start-3 row-start-2 md:col-start-2 md:row-start-1 justify-self-end">
          <span className="text-thenex-gray dark:text-darkmode-lighter text-sm">als</span>
      ...
      <div
        ...
        } md:justify-self-center text-thenex-gray dark:text-darkmode-lighter text-sm`}
      >
        {file.calculatedSize}
      </div>
      {type === "excel" ? (
